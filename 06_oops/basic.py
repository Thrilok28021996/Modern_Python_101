...
class Person:
    ...
    def __repr__(self) -> str:
        """Official Representation of a class."""
        return '<class "Person">'

    def __str__(self) -> str:
        """This magic method string representation of an instance."""
        return f"Person:{self.first_name} {self.last_name}"

    def greet(self) -> None:
        """Method that prints greeeting message."""
...
# calling the methods on particular instances
p1.greet()
p2.greet()
