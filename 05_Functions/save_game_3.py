"""
convert game to smaller functions
...
group common functionality into individual functions.
...
Note:
-----
We will also learn about global & local scope of variables (Using scratchpad)
